...
void DirPscanAna(const char* dirpath, int steps){
    std::vector<string> K_MODULE_IDs = {"101", "102", "103", "104", "106", "107", "108", "109", "206", "207"};
    ...
    ifstream ifs("./EfuseMap_20250317_2357.json", ios::in);
    if(ifs.fail()){
        //cerr << "Failed to read EfuseMap.json" << endl;
        cerr << "Failed to read EfuseMap_20250317_2357.json" << endl;
        return 1;
    }
